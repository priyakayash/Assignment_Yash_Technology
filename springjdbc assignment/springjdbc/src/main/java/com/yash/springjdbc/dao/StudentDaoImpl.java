...
public class StudentDaoImpl implements StudentDao {
	...
	public int insert(Student stu) {
		...
		String q="insert into student(id,name,address,mobile_no ) values(?,?,?,?)";
    	int msg=this.jdbctemp.update(q,stu.getId(),stu.getName(),stu.getAddress(),stu.getMobile_no());
		return msg;
	}
	...
	public int updatedetails(Student stu) {
		...
		String q="update student set name=?,address=?,mobile_no=? where id=?";
		int msg=this.jdbctemp.update(q,stu.getName(),stu.getId(),stu.getAddress(),stu.getMobile_no());
